    ...
    <div className="min-h-screen bg-paper text-ink font-body antialiased grid lg:grid-cols-2 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col justify-center items-center p-8 sm:p-12 bg-paper border-l border-ink/5">
        ...
        <div className="max-w-sm w-full space-y-6">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative rounded-xl">
                ...
                <input
                  type="email" required placeholder="name@business.com" value={email}
            ...
            >
              {loading ? (
                <><RefreshCw size={13} className="animate-spin" /><span className="text-paper">Signing in…</span></>
              ) : (
                <><span className="text-paper">Sign In to Dashboard</span><ArrowRight size={13} className="group-hover:translate-x-0.5 transition-transform text-paper" /></>
              )}
            </button>
          </form>
          ...
          {/* Google */}
          <button
            type="button" disabled={loading} onClick={handleGoogleLogin}
          ...
          {/* Facebook */}
          <button
            type="button" disabled={loading} onClick={handleFacebookLogin}
          ...
          {/* Direct plain links — no modal dependency */}
          <p className="text-center text-[11px] text-ink/40 leading-relaxed pt-2">
